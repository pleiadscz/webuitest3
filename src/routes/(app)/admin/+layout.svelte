		...
		<nav class="   px-2.5 pt-1.5 backdrop-blur-xl drag-region select-none">
			<div class=" flex items-center gap-1">
				...
				<div class=" flex w-full">
					...
					>
						<!-- Settings moved to first position; Analytics and Evaluations removed -->
						<a
							draggable="false"
						...
						<a
							draggable="false"
							class="min-w-fit p-1.5 {$page.url.pathname === '/admin' || $page.url.pathname.includes('/admin/users')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition select-none"
